...
Sprite *Msprite;
Sprite *bordertile, *grasstile, *castletile, *walltile, *bloodtile, *doortile; //Sprites for the tiles -- CPG
int NumSprites;
...
void InitTiles()
{
	...
	if (bordertile == NULL)fprintf(stdout, "bordertile didnt load \n");
	grasstile = LoadSprite("images/deadgrass.png",64,48);
	if (grasstile == NULL)fprintf(stdout, "grasstile didnt load \n");
	castletile = LoadSprite("images/castletile.png",64,48);
	if (castletile == NULL)fprintf(stdout, "castletile didnt load \n");
	walltile = LoadSprite("images/wall.png",64,48);
	if (walltile == NULL)fprintf(stdout, "walltile didnt load \n");
	bloodtile = LoadSprite("images/blood.png",64,48);
	if (bloodtile == NULL)fprintf(stdout, "bloodtile didnt load \n");
	doortile = LoadSprite("images/door.png",64,48);
	if (doortile == NULL)fprintf(stdout, "doortile didnt load \n");
}
/*
void drawLevel(int currentLevel)
{
